    ...
    <Card>
      ...
      <CardContent>
        <ResponsiveContainer width="100%" height={350}>
          <LineChart data={analysisData} margin={{ top: 5, right: 30, left: 0, bottom: 5 }}>
            <CartesianGrid strokeDasharray="3 3" />
            <XAxis dataKey="year" />
            <YAxis />
            <Tooltip />
            <Legend />
            <Line type="monotone" dataKey="rumah" stroke="#3b82f6" name="Rumah" strokeWidth={2} />
            <Line type="monotone" dataKey="rlh" stroke="#10b981" name="RLH" strokeWidth={2} />
            <Line type="monotone" dataKey="rtuh" stroke="#ef4444" name="RTUH" strokeWidth={2} />
            <Line type="monotone" dataKey="rumahBaru" stroke="#8b5cf6" name="Butuh Rumah Baru" strokeWidth={2} />
          </LineChart>
        </ResponsiveContainer>
      </CardContent>
    </Card>
