...
import ApprovalHouseholdsTable from '@/components/household/households-list/approval-households-table';
            ...
            <div className='flex h-full flex-1 flex-col gap-4 overflow-x-auto p-4'>
                ...
                <div>
                    <div className='flex flex-row gap-3'>
                        ...
                        <h1 className="text-2xl font-bold">Approval Data Rumah</h1>
                    </div>
                </div>

                {/* approval table */}
                <ApprovalHouseholdsTable
