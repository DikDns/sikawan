    ...
    const filteredData = useMemo(() => {
        ...
        return roles.filter((rl) => {
            const permText = rl.feature_groups
                ...
                .toLowerCase();
            return (
                rl.name.toLowerCase().includes(lower) ||
                permText.includes(lower)
            );
        });
    }, [searchQuery, roles]);
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto p-4">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="relative mt-4 flex items-center gap-3 sm:mt-0 sm:w-1/2">
                        ...
                        {viewDialog.open && (
                            <ViewLevel
                                ...
                                onOpenChange={(open) =>
                                    setViewDialog({
                                        open,
                                        role: open ? viewDialog.role : null,
                                    })
                                }
