...
Route::get('/', function () {
    $kawasanCount = \App\Models\Area::count();
    $rumahCount = \App\Models\Household\Household::where('is_draft', false)->count();
    $rtlhCount = \App\Models\Household\Household::where('is_draft', false)
